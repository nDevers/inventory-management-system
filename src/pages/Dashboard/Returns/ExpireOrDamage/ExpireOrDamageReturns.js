...
import ExpireOrDamageReturnsRow from './ExpireOrDamageReturnsRow';
...
const ExpireOrDamageReturns = () => {
    ...
    return (
        <div>
            <h2 className='text-2xl text-center font-bold'>Expire or Damage Returns</h2>
...
export default ExpireOrDamageReturns;