...
const ExpiresOrDamagesReturns = () => {
    ...
    const addExpireOrDamageReturn = event => {
        ...
        // send data to server
        fetch('https://stringlab-ims-server.herokuapp.com/api/returns/expiresOrDamagesReturns', {
            method: 'POST',
            headers: {
    ...
    return (
        <section className='p-4 mt-16'>
            <DashboardPageHeading
                name='Expire / Damages Returns'
                value={expiresOrDamagesReturns.length}
                buttons={[
                                ...
                                tableRowsData={
                                    [
                                        ...
                                        <span className='flex items-center gap-x-1'>
                                            <EditButton />
                                            <DeleteButton
                                                deleteApiLink='https://stringlab-ims-server.herokuapp.com/api/returns/expiresOrDamagesReturns/'
                                                itemId={product._id}
...
export default ExpiresOrDamagesReturns;